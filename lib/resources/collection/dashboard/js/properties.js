...
var propertyTypes = [
      {
        ...
        , tooltipTitle: "JSON Array"
          ...
          id: 'date'
        , label: 'date'
        , tooltip: "Add a Date property. The incoming value should be a numeric value corresponding to the time for the specified date according to universal time."
        , tooltipTitle: "Date in milliseconds since 1970/01/01"
      }
    ];
